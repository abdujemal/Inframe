...
class PhotographerCheckBids extends StatefulWidget {
  const PhotographerCheckBids({Key? key}) : super(key: key);

  @override
  State<PhotographerCheckBids> createState() => _PhotographerCheckBidsState();
}

class _PhotographerCheckBidsState extends State<PhotographerCheckBids> {
  var numOfbid = 10;

  var bidRef = FirebaseDatabase.instance.reference().child("Bids");
          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                ...
                StreamBuilder( 
                    stream: bidRef.limitToFirst(numOfbid).onValue,
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasData) {
                        ...
                        questionMap.forEach((key, value) {
                          final bidItem = Map<String, dynamic>.from(value);
                          final bidModel = Bid.fromRTDB(bidItem);
